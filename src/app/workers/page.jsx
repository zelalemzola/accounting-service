...
const Workers = () => {
  ...
  return (
    <div className="w-full mx-auto mt-[20px] flex flex-col ">
      <div className="w-full flex flex-wrap items-center justify-between fixed top-0 z-30 bg-white border-b rounded-b-2xl sm:px-[5%] md:px-[10%] py-3 shadow-md">
      <Link href='/'><ArrowLeft fontWeight='bold' size={33} className="text-white bg-primary font-bold p-1 rounded-full md:scale-200 cursor-pointer" /></Link>
        <p className="text-primary text-lg md:text-2xl font-bold flex items-center gap-6">Available Accountants</p>
